...
public class LockPersistence {
    ...
    public static void save() {
        ...
        for (var e : DashboardAdmin.getAllLockedBlocks().entrySet()) {
        ...
        for (var e : DashboardAdmin.getAllTrustedPlayers().entrySet()) {
        ...
        for (var e : DashboardAdmin.getPlayerNameCache().entrySet()) {
    ...
    public static void load() {
        ...
        try {
            ...
            if (root.has("lockedBlocks")) {
                Map<BlockPos, UUID> locks = DashboardAdmin.getAllLockedBlocks();
            ...
            if (root.has("trustedPlayers")) {
                for (var e : root.getAsJsonObject("trustedPlayers").entrySet()) {
                    ...
                    Set<UUID> set = DashboardAdmin.getTrusted(owner);
            ...
            if (root.has("playerNameCache")) {
                Map<UUID, String> cache = DashboardAdmin.getPlayerNameCache();
