...
public class HomePersistence {
    ...
    public static void save() {
        ...
        for (var entry : DashboardAdmin.getAllHomes().entrySet()) {
            JsonObject playerObj = new JsonObject();
            Map<String, String> dims = DashboardAdmin.getPlayerHomesDim(entry.getKey());
    ...
    public static void load() {
        ...
        try {
            ...
            for (var entry : json.entrySet()) {
                ...
                Map<String, BlockPos> homes = DashboardAdmin.getPlayerHomes(uuid);
                Map<String, String>  dims  = DashboardAdmin.getPlayerHomesDim(uuid);
