...
**[Télécharger la v1.0.8 (.jar)](https://github.com/LKDM7/DashBoardAdmin/raw/master/releases/dashboardadmin-1.0.8.jar)**
...
- **Zones** : création et gestion de zones protégées, visualisation en jeu (wireframe)
